...
import { type Channel, type DMChannel, type ForumChannel, type PrivateThreadChannel, type PublicThreadChannel, type TextChannel, ChannelType } from "discord.js";
...
export function isSupportedChannel(channel: Optional<Channel>): channel is SupportedChannel {
