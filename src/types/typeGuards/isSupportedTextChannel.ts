...
import { type Channel, type DMChannel, type PrivateThreadChannel, type PublicThreadChannel, type TextChannel, ChannelType } from "discord.js";
...
export function isSupportedTextChannel(channel: Optional<Channel>): channel is SupportedTextChannel {
