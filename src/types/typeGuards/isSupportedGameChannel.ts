...
import { ChannelType, type Channel, type ForumChannel, type PrivateThreadChannel, type PublicThreadChannel, type TextChannel } from "discord.js";
...
export function isSupportedGameChannel(channel: Optional<Channel>): channel is SupportedGameChannel {
